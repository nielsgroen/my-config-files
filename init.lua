...
-- Bootstrap packer, the package manager
...
-- Speedup package load
-- If 'impatient' not found: comment this line out
-- Uncomment after 'impatient' is installed
-- require('impatient')
...
vim.cmd("au BufWinEnter * normal zR")
...
vim.api.nvim_set_keymap('n', "Db", ":call vimspector#ToggleBreakpoint()<cr>", { noremap = true })
vim.api.nvim_set_keymap('n', "Dw", ":call vimspector#AddWatch()<cr>", { noremap = true })
vim.api.nvim_set_keymap('n', "De", ":call vimspector#Evaluate()<cr>", { noremap = true })
